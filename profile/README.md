...
- **[autopilot](https://github.com/pavlov-net/autopilot)** — *You are the bottleneck. Get out of the way.* Orchestration for multi-agent Claude workflows.
...
- **[tripo3d-rs](https://github.com/pavlov-net/tripo3d-rs)** — Tripo3D Rust SDK, CLI, and MCP server for generating 3D assets.

## Side Projects

- **[clawtornot](https://github.com/pavlov-net/clawtornot)** — Hot-or-not, but for OpenClaw / agents.
